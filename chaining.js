...
var sortedShit = numbers.sort(function(first,second){return second - first})
				.filter(function(number) {if (number <= 19) {return true;}})
				.map(function(fruit) {return (fruit * 1.5) -1;})
